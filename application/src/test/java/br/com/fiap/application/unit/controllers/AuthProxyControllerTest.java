...
class AuthProxyControllerTest {
    ...
    void loginWithoutUrlReturnsServiceUnavailable() {
    ...
    void loginWithUrlSuccessReturnsLambdaResponse() {
        ...
        mockServer.expect(requestTo("http://lambda.example.com/login"))
    ...
    void authLoginRequestGettersAndSetters() {
    ...
    void authLoginRequestTwoArgConstructor() {
